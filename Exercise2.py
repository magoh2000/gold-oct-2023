...
lowtaxland_amount =  lowtaxland_rate * income 
ripoffland_amount =  ripoffland_rate * income
print('Your income is', income,'and you would pay', lowtaxland_amount,'income tax in Lowtaxland or', ripoffland_amount,'income tax in Ripoffland. You would save', ripoffland_amount - lowtaxland_amount,'by paying taxes in Lowtaxland!')
